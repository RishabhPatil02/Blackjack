...
function init(){
    ...
    document.querySelector('#blackjack-stand-button').addEventListener('click',  dealerLogic,true);

    document.querySelector('#blackjack-deal-button').addEventListener('click',  blackjackDeal,true);
